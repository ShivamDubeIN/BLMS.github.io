<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterUser.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Book_Library.PageUser.MyProfile" %>
     ...
     <div id="content">
        <div class="search">
             <table cellpadding="5" cellspacing="2" style="width: 573px; text-align:center; margin-right: 0px;">
                <tr>
                    <th colspan="3">Fill Your Information</th>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
