<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterUser.master" AutoEventWireup="true" CodeFile="Setting.aspx.cs" Inherits="Book_Library.PageUser.Setting" %>
        ...
        <div style="width: 70%">
            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="fancy fancy-green" TabStripPlacement="Top">
                ...
                <asp:TabPanel ID="TabPanel2" runat="server">
                    ...
                    <ContentTemplate>
                        <asp:ChangePassword ID="ChangePassword1" runat="server" Height="300px" CancelDestinationPageUrl="~/PageUser/MyProfile.aspx" ContinueDestinationPageUrl="~/PageUser/MyProfile.aspx" CssClass="chpass" OnChangedPassword="ChangePassword1_ChangedPassword"></asp:ChangePassword>
                    </ContentTemplate>
                </asp:TabPanel>
