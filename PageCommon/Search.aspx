<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Book_Library.PageCommon.Search" %>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <center><asp:ImageButton ID="imgSearchbooks" runat="server" 
                            ImageUrl="~/Images/sera.png" OnClick="imgSearchbooks_Click" Height="41px" 
